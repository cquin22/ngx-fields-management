...
import {IFormValidation} from "../interfaces";
import {ValidationsType, FieldPositionColumnType} from "../enums";
import {IFieldPosition, IControlConfig, IField} from "../interfaces";
...
export class DynamicFormService {
  ...
  private buildErrors(validator: IFormValidation): Validators {
    ...
    switch (validator.type ){
      ...
      case  ValidationsType.MIN_LENGTH:
        return Validators.minLength(validator.value);
      case  ValidationsType.MAX__LENGTH:
